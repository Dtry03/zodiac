                ...
                <div class="p-6 text-gray-400 bg-table-bg-color">
                    ...
                    <form method="POST" action="{{ route('admin.gym_classes.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full  border-gray-400 bg-table-bg-color" type="text" name="name" :value="old('name')" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="start_time" class="block mt-1 w-full  border-gray-400 bg-table-bg-color" type="time" name="start_time" :value="old('start_time')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="duration_minutes" class="block mt-1 w-full  border-gray-400 bg-table-bg-color" type="number" name="duration_minutes" :value="old('duration_minutes', 60)" required min="15" />
                        ...
                        <div>
                            ...
                            <x-text-input id="capacity" class="block mt-1 w-full  border-gray-400 bg-table-bg-color" type="number" name="capacity" :value="old('capacity', 10)" required min="1" />
                        ...
                        <div class="flex items-center gap-4 mt-6">
                            <button style="background-color: {{ $bgColor }};" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest">{{ __('Guardar Clase') }}</button>
