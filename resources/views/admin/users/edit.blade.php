                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user->id) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="email" class="block mt-1 w-full bg-gray-100 dark:bg-gray-700" type="email" name="email" :value="old('email', $user->email)" required readonly />
                        ...
                        {{-- Campo Username (Quizás hacerlo readonly) --}}
                         <div>
                            ...
                            <x-text-input id="username" class="block mt-1 w-full bg-gray-100 dark:bg-gray-700" type="text" name="username" :value="old('username', $user->username)" readonly />
                        ...
                        <div>
                            ...
                            <select name="role" id="role" required class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
